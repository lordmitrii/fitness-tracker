...
import { fetchProfile } from "@/src/entities/profile";
import { fetchPlans } from "@/src/entities/workout-plan";
import { fetchCurrentCycle } from "@/src/entities/current-cycle";
import { fetchSettings } from "@/src/entities/settings";
import { fetchVersions } from "@/src/shared/api/versions";
