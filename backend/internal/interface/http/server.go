...
func NewServer(exerciseService usecase.ExerciseService, workoutService usecase.WorkoutService, userService usecase.UserService, aiService usecase.AIService, emailService usecase.EmailService) *gin.Engine {
	...
	handler.NewAIHandler(api, aiService)
	handler.NewEmailHandler(api, emailService)
