...
import { WorkoutForm } from "@/src/widgets/workout-form";
import { useCycleData } from "@/src/entities/workout-cycle";
import { ErrorState, LoadingState } from "@/src/shared/ui/states";
...
export default function UpdateWorkoutScreen() {
  ...
  const targetWorkout = useMemo(
    () =>
      workouts.find(
        (w: { id?: string | number }) => String(w.id) === String(resolvedWorkoutID ?? "")
      ),
